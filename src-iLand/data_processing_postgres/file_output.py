...
class FileOutputManager:
    ...
    def generate_enhanced_markdown_content(self, doc: SimpleDocument) -> str:
        """Generate enhanced markdown content with metadata sections from a document
        This is used for both saving to files and database storage"""
    ...
    def save_documents_as_markdown_files(self, documents: List[SimpleDocument], prefix: str = "deed", batch_size: int = 1000) -> List[str]:
        ...
        for idx, doc in enumerate(documents, 1):
            ...
            markdown_content = self.generate_enhanced_markdown_content(doc)
